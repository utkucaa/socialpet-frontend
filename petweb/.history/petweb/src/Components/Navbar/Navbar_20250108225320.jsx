...
const Navbar = ({ user, setUser }) => {
  ...
  const handleCreateAdClick = () => {
    if (!user) {
      navigate('/login'); // Eğer kullanıcı giriş yapmamışsa giriş sayfasına yönlendir
    } else {
  ...
  return (
    <div className='n-container'>
      ...
      <div className="n-right">
        ...
        {/* Hemen İlan Ver butonuna tıklayınca giriş yapılmadıysa login sayfasına, yapıldıysa ilan sayfasına yönlendir */}
