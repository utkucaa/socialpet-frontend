  ...
  return (
    <div className="question-detail">
      <div className="question-header">
        <h2>{question?.title || 'Başlık yok'}</h2> {/* title varsa göster, yoksa 'Başlık yok' */}
      </div>
      <div className="question-content">
        ...
        <div className="question-details">
          <p>{question?.details || 'Soru detayları bulunmamaktadır.'}</p> {/* details varsa göster, yoksa varsayılan metin */}
        </div>
      </div>

      <div className="answers">
        <div className="answers-header">
          <h4>{question?.answers || 0} Cevap</h4> {/* answers varsa göster, yoksa 0 */}
        </div>
        <div className="answer-message">
          <p>Soruya cevap yazabilmek için üye girişi yapmalısınız.</p>
          <button className="üye">Üye Ol</button>
          <button className="giriş">Giriş Yap</button>
        </div>
      </div>
