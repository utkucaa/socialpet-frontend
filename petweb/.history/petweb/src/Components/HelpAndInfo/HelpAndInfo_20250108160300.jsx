...
const HelpAndInfo = () => {
  ...
  const [selectedQuestion, setSelectedQuestion] = useState(null); // Seçilen soruyu tutmak için state
        ...
        <div className="questions-container">
          {questions.map((question, index) => (
            <div 
              ...
              onClick={() => setSelectedQuestion(question)} // Tıklanan soruyu ayarlıyoruz
            >
