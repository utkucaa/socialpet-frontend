...
const LostItemList = () => {
  ...
  return (
    <div className="lost-item-list">
      ...
      {/* Kayıp Kediler Bölümü */}
      <div id="lost-cats" className="category">
      ...
      {/* Kayıp Köpekler Bölümü */}
      <div id="lost-dogs" className="category">
      ...
      {/* Kayıp Papağanlar Bölümü */}
      <div id="lost-parrots" className="category">
      ...
      {/* Kayıp Muhabbet Kuşları Bölümü */}
      <div id="lost-lovebirds" className="category">
