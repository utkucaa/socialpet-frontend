...
const AdDetail = () => {
  ...
  return (
    <div className="ad-detail-container">
     ...
     <p>Ragdoll kedisi sahiplendirme ilanı. 2 aylık erkek/dişi yavrularımız aşıları yapılmış, sağlık kontrolleri tamamlanmış şekilde yeni ailelerini bekliyor.</p>
    </div>
    </div>
