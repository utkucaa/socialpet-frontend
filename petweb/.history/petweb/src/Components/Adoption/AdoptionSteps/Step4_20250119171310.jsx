...
const Step4 = ({ adoptionData }) => {
  ...
  const handlePublishAd = async () => {
    try {
      ...
      // Fotoğraf için ayrı bir FormData oluştur
      const photoFormData = new FormData();
      if (adoptionData.photo) {
        photoFormData.append("photo", adoptionData.photo);
      }

      // İlan verilerini JSON olarak hazırla
      const adData = {
      ...
      // Eğer fotoğraf varsa ve ilan başarıyla oluşturulduysa, fotoğrafı ayrıca gönder
