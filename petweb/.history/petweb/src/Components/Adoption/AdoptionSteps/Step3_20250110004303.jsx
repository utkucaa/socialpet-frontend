...
const Step3 = ({ onNext, adId }) => {
  const [file, setFile] = useState(null); // Seçilen dosya durumu
  const [fileName, setFileName] = useState(""); // Dosya adı durumu
  ...
  return (
    <div className="step step3">
      <h3>Sahiplendirme İlanı Ver - 3. Adım: Fotoğraflar</h3>
      <p>
