  ...
  return (
    <div className="ad-detail-container">
      ...
      <div className="ad-content">
       ...
       <p>Bu ilan, Ragdoll cinsinden 2 aylık bir kediyi sahiplendirmek isteyen kullanıcılar için oluşturulmuştur. Eylül Kaya tarafından verilen bu ilan, İstanbul Maltepe'den yayımlanmıştır. İlanda, kedinin yaşı, cinsiyeti ve sağlık durumu gibi önemli bilgiler yer almaktadır. Sahiplenme durumu "Görüşülür" olarak belirtilmiştir. Detaylı bilgi almak için ilan sahibine ulaşabilirsiniz.</p>
       </div>
        ...
        <div className="specifications">
          ...
          <table className="specs-table">
            <tbody>
              ...
              <tr>
                <td>Kredi Kartına Ödeme</td>
                <td>{adDetails.specifications.creditCardPayment}</td>
              </tr>
              <tr>
        ...
        <div className="contact-box">
          ...
          <div className="warning-box">
            ...
            <p>Patibul.com, pet arayanlar ve sahiplendirme yapanları buluşturan bir platform olup, satış yapmamaktadır. Bunun için hayvan alacak kişilerin, hayvan satan kişilerle mutlaka yüz yüze görüşmesi gerektiğini söylemektedir. Yüz yüze görüşülmeyen kişilere hiçbir şekilde kaparo ya da bir ödeme yapılmamalıdır.</p>
          </div>
